...
document.addEventListener('DOMContentLoaded', () => {
    // Observe animated elements with requestIdleCallback for better performance
    ...
    // Create dynamic bubbles with delay
    requestAnimationFrame(() => createDynamicBubbles());
});
    ...
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await emailjs.send(
                'service_ms3bfn3', // Service ID
                'template_0lsl552', // Template ID
                {
                    from_name: data.name,
